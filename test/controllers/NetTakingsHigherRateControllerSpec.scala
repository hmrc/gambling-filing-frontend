...
class NetTakingsHigherRateControllerSpec extends SpecBase with MockitoSugar {

  val formProvider = new NetTakingsHigherRateFormProvider()
  ...
  "NetTakingsHigherRate Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, netTakingsHigherRateRoute)
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers =
        UserAnswers(userAnswersId)
          .set(NetTakingsHigherRatePage, validAnswer)
          .success
          .value
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, netTakingsHigherRateRoute)
