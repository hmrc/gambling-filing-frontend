...
class NegativeDutyBroughtForwardInputControllerSpec extends SpecBase with MockitoSugar {

  val formProvider = new NegativeDutyBroughtForwardInputFormProvider()
  ...
  lazy val negativeDutyBroughtForwardInputRoute: String =
    routes.NegativeDutyBroughtForwardInputController.onPageLoad(NormalMode).url

  "NegativeDutyBroughtForwardInput Controller" - {
