...
import models.SubmittedReturnsTestData.validResponseSubmittedReturns
...
object SubmittedReturnsTestData {
  ...
  val zeroResponseSubmittedReturns = SubmittedReturns(items = Seq())
}
