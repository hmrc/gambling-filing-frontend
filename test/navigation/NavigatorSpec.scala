...
class NavigatorSpec extends SpecBase {
  ...
  "Navigator" - {
    ...
    "in Normal mode" - {
      ...
      "must go from NetTakingsLowerPage to MgdLowerRatePage" in {
        navigator.nextPage(
          NetTakingsLowerPage,
          NormalMode,
          emptyUserAnswers
      ...
      "must go from NetTakingsStandardPage to MgdStandardRatePage" in {
        navigator.nextPage(
      ...
      "must go from NetTakingsHigherPage to MgdHigherRatePage" in {
        navigator.nextPage(
      ...
      "must go from DeclareAndSubmitPage to Confirmation page" in {
        navigator.nextPage(
