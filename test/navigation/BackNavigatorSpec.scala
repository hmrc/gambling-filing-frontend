  ...
  "BackNavigator" - {
    ...
    "in Normal mode" - {
      ...
      "in Check mode" - {
        ...
        "must go to UnderDeclaredDutyController in CheckMode when reasonable care answer is not found" in {
          val request: OptionalDataRequest[AnyContent] =
            OptionalDataRequest(
              FakeRequest(),
              "reg123",
          ...
          navigator.backPage(
            ...
            CheckMode,
            request
          ) mustBe Some(routes.UnderDeclaredDutyController.onPageLoad(CheckMode).url)
        }

        "must go to CheckYourAnswersController from UnderDeclaredDutyReasonableCarePage in CheckMode when the answer exists" in {
          val userAnswers =
            emptyUserAnswers
              .set(UnderDeclaredDutyReasonableCarePage, true)
              .success
          ...
          navigator.backPage(
            ...
            CheckMode,
            request
          ) mustBe Some(routes.CheckYourAnswersController.onPageLoad().url)
        }

        "must go to UnderDeclaredDutyReasonableCareController from UnderDeclaredDutyLimitsPage in CheckMode when the answer is missing" in {
          val request: OptionalDataRequest[AnyContent] =
            OptionalDataRequest(
              FakeRequest(),
              "reg123",
          ...
          navigator.backPage(
            ...
            CheckMode,
            request
          ) mustBe Some(routes.UnderDeclaredDutyReasonableCareController.onPageLoad(CheckMode).url)
        }

        "must go to CheckYourAnswersController from UnderDeclaredDutyLimitsPage in CheckMode when the answer exists" in {
          val userAnswers =
            emptyUserAnswers
              .set(UnderDeclaredDutyLimitsPage, true)
              .success
        ...
        "must go to UnderDeclaredDutyLimitsController from TotalUnderDeclaredDutyPage in CheckMode when the answer is missing" in {
          val request: OptionalDataRequest[AnyContent] =
            OptionalDataRequest(
              FakeRequest(),
              "reg123",
          ...
          navigator.backPage(
            ...
            CheckMode,
            request
          ) mustBe Some(routes.UnderDeclaredDutyLimitsController.onPageLoad(CheckMode).url)
        }

        "must go to CheckYourAnswersController from TotalUnderDeclaredDutyPage in CheckMode when the answer exists" in {
          val userAnswers =
            emptyUserAnswers
              .set(TotalUnderDeclaredDutyPage, BigDecimal("27000"))
              .success
              .value
