...
trait ApplicationWithWiremock extends AnyWordSpec with GuiceOneServerPerSuite with BeforeAndAfterAll with BeforeAndAfterEach:
  ...
  val extraConfig: Map[String, Any] = {
    Map(
      ...
      "microservice.services.gambling.port"     -> WireMockConstants.stubPort
    )
  }
