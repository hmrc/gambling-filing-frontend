...
checkYourAnswers.caption = File a return for {0} to {1}
checkYourAnswers.mgd.question = Is the calculated MGD correct?
checkYourAnswers.enterMGD = Enter MGD
checkYourAnswers.enterNumber = Enter number
checkYourAnswers.enterNetTakings = Enter net takings
checkYourAnswers.enterAmount = Enter amount
checkYourAnswers.setValue = Set value
checkYourAnswers.lowerRate.heading = Lower rate of duty
checkYourAnswers.standardRate.heading = Standard rate of duty
checkYourAnswers.higherRate.heading = Higher rate of duty
checkYourAnswers.underDeclaredDuty.heading = Under-declared duty
checkYourAnswers.dutyBroughtForward.heading = Duty brought forward
checkYourAnswers.totalDueLowerRate = MGD due at lower rate of duty
checkYourAnswers.totalDueStdRate = MGD due at standard rate of duty
checkYourAnswers.totalDueHigherRate = MGD due at higher rate of duty
checkYourAnswers.underDeclaredDutyReasonableCare.question = Did you fail to take reasonable care when you under-declared your duty?
checkYourAnswers.underDeclaredDutyLimits.question = Does the amount you wish to declare fall within the limits?
checkYourAnswers.totalUnderDeclaredDuty.question = Under-declared duty from previous periods
...
machinesAvailable.error.negative = The number of machines must be 0 or more
machinesAvailable.error.maximum = The number of machines must be less than 10 million
...
introduction.title = File a return
introduction.heading = File a return for {0} to {1}
introduction.p1 = To file your return, you will need:
introduction.bullet.1 = the number of machines available for play at the end of the return period
introduction.bullet.2 = the total net takings from machine games liable to lower rate of duty
introduction.bullet.3 = the total net takings from machine games liable to standard rate of duty
introduction.bullet.4 = the total net takings from machine games liable to higher rate of duty
introduction.bullet.5 = the amount of under-declared duty from previous returns
introduction.bullet.6 = the negative amount of duty brought forward from previous returns
introduction.underDeclared.h2 = Under-declared duty
introduction.underDeclared.p.before = If you have under-declared duty from a previous return to declare, refer to the
introduction.underDeclared.p.link = Machine Games Duty guidance page (opens in new tab)
introduction.underDeclared.p.after = before you begin. There are limits on how much under-declared duty you can declare online in any return.
...
mgdLowerRate.hint = Enter pounds and pence, like £1,150.72
...
mgdStandardRate.hint = Enter pounds and pence, like £1,150.72
...
netTakingsLower.hint = Enter pounds and pence, like £1,150.72
...
netTakingsStandard.heading = What are your total net takings liable to the standard rate of duty?
netTakingsStandard.caption = File a return for {0} to {1}
netTakingsStandard.hint = Enter pounds and pence, like £1,150.72
...
netTakingsHigher.hint = Enter pounds and pence, like £1,150.72
...
calculatedMGDLowerRate.title = MGD for the lower rate of duty
calculatedMGDLowerRate.heading = We have worked out your MGD at the lower rate to be {0}
calculatedMGDLowerRate.subheading = Is this correct?
calculatedMGDLowerRate.caption = File a return for {0} to {1}
calculatedMGDLowerRate.body = This is based on {0}% of your declared net takings of {1}
calculatedMGDLowerRate.error.required = Select yes if this calculation is correct
...
calculatedMGDHigherRate.title = MGD for the higher rate of duty
calculatedMGDHigherRate.heading = We have worked out your MGD at the higher rate to be {0}
calculatedMGDHigherRate.subheading = Is this correct?
calculatedMGDHigherRate.caption = File a return for {0} to {1}
calculatedMGDHigherRate.body = This is based on {0}% of your declared net takings of {1}
calculatedMGDHigherRate.error.required = Select yes if this calculation is correct

selectFiledReturn.title = Pa gyfnod yr hoffech chi ei weld?
selectFiledReturn.caption = Bwrw golwg dros ddatganiad rydych wedi’i gyflwyno
selectFiledReturn.heading = Pa gyfnod yr hoffech chi ei weld?
selectFiledReturn.table.returnPeriod = Cyfnod y datganiad
selectFiledReturn.table.returnPeriod.dates = {0} i {1}
selectFiledReturn.table.dateFiled = Dyddiad cyflwyno
selectFiledReturn.table.reference = Cyfeirnod
selectFiledReturn.empty.heading = Does dim datganiadau wedi’u cyflwyno
selectFiledReturn.empty.body = Nid ydych wedi cyflwyno unrhyw ddatganiadau Toll Peiriannau Hapchwarae.

submittedReturn.dates = Manylion datganiad {0} i {1}
submittedReturn.caption = Bwrw golwg dros y datganiad rydych wedi’i gyflwyno
submittedReturn.submissionDetails = Manylion cyflwyno
submittedReturn.returnDetails = Manylion y datganiad
submittedReturn.submittedDate = Dyddiad cyflwyno
submittedReturn.ackRef = Cyfeirnod cydnabyddiaeth
submittedReturn.noOfMachines = Nifer y peiriannau sydd ar gael i’w chwarae
submittedReturn.netTakingsLowerRate = Derbyniadau net sy’n agored i doll ar y gyfradd is
submittedReturn.totalDueLowerRate = Y doll peiriannau hapchwarae (MGD) sy’n ddyledus ar y gyfradd is
submittedReturn.netTakingsStdRate = Derbyniadau net sy’n agored i doll ar y gyfradd safonol
submittedReturn.totalDueStdRate = Y doll peiriannau hapchwarae (MGD) sy’n ddyledus ar y gyfradd safonol
submittedReturn.netTakingsHigherRate = Derbyniadau net sy’n agored i doll ar y gyfradd uwch
submittedReturn.totalDueHigherRate = Y doll peiriannau hapchwarae (MGD) sy’n ddyledus ar y gyfradd uwch
submittedReturn.dutyPayable = Y doll sy’n daladwy cyn unrhyw addasiadau
submittedReturn.underDeclaredDuty = Treth sydd wedi’i thanddatgan o ddatganiadau blaenorol
submittedReturn.previousReturnAmount = Swm a ddygwyd ymlaen
submittedReturn.negativeAmountCarriedForward = Swm negyddol o’r doll i’w gario ymlaen i’r datganiad nesaf
submittedReturn.totalNetDutyPayable = Y doll peiriannau hapchwarae (MGD) net sy’n daladwy ar y datganiad hwn
...
netTakingsLowerRate.p1 = To qualify for the lower rate of duty, every dutiable game on the machine must:
netTakingsLowerRate.bullet1 = cost no more than 20p to play
netTakingsLowerRate.bullet2 = have a maximum cash prize of £10
netTakingsLowerRate.question = Do you have any net takings liable to the lower rate of duty?
netTakingsLowerRate.error.required = Select yes if you have net takings liable to the lower rate of duty

netTakingsStandardRate.title = Net takings for the standard rate of duty
netTakingsStandardRate.heading = Net takings for the standard rate of duty
netTakingsStandardRate.caption = File a return for {0} to {1}
netTakingsStandardRate.p1 = To qualify for the standard rate of duty the:
netTakingsStandardRate.bullet1 = machine must not qualify for the lower rate of duty
netTakingsStandardRate.bullet2 = cost to play every dutiable game on the machine once is no more than £5
netTakingsStandardRate.question = Do you have any net takings liable to the standard rate of duty?
netTakingsStandardRate.error.required = Select yes if you have net takings liable to the standard rate of duty

netTakingsHigherRate.title = Net takings for the higher rate of duty
netTakingsHigherRate.heading = Net takings for the higher rate of duty
netTakingsHigherRate.caption = File a return for {0} to {1}
...
negativeDutyBroughtForwardInput.title = What is the amount of duty brought forward from your previous return?
negativeDutyBroughtForwardInput.heading = What is the amount of duty brought forward from your previous return?
negativeDutyBroughtForwardInput.hint = Enter an amount in pounds and pence, like £1,510.72
...
negativeDutyBroughtForwardInput.error.range = The amount of duty brought forward from your previous return must be between -£1 billion and £1 billion
...
negativeDuty.title = Duty brought forward from your previous return
negativeDuty.heading = Duty brought forward from your previous return
negativeDuty.p1 = If your previous return resulted in a negative amount of MGD, you can carry it forward into this return.
negativeDuty.caption = File a return for {0} to {1}
negativeDuty.question = Did you have a negative amount of MGD in your previous return?
negativeDuty.error.required = Select yes if you had a negative amount of MGD in your previous return

totalUnderDeclaredDuty.title = How much under-declared duty do you have from previous returns?
totalUnderDeclaredDuty.heading = How much under-declared duty do you have from previous returns?
totalUnderDeclaredDuty.caption = File a return for {0} to {1}
...
totalUnderDeclaredDuty.error.greaterThanZero = Your under-declared duty must be more than 0

declareAndSubmit.title = Declare and submit
declareAndSubmit.heading = Declare and submit
declareAndSubmit.caption = File a return for {0} to {1}
declareAndSubmit.dutyPayableBeforeAdjustments = Duty payable before any adjustments
declareAndSubmit.underDeclaredTaxFromPreviousPeriods = Under-declared tax from previous periods
...
confirmation.submission = Your Machine Games Duty return for period {0} to {1} was successfully submitted on {2}.
confirmation.processing.p1 = Your return should be processed within 24 hours and be available to view in your submitted returns in 48 hours. If you still cannot see it after this time, contact the
confirmation.helpdesk.link = Online Services Helpdesk (opens in new window)
confirmation.processing.p2 = and quote your reference number.
confirmation.whatHappensNext.heading = What happens next?
confirmation.whatHappensNext.directDebit = If you pay by Direct Debit, any tax due declared on this return will be automatically debited from your bank account. HMRC will notify you by post of the payment collection date in advance.
