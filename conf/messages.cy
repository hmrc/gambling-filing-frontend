...
openReturns.title = Which period are you filing a return for?
openReturns.caption = File a return
openReturns.heading = Which period are you filing a return for?
openReturns.table.returnPeriod = Return period
openReturns.table.returnPeriod.dates = {0} to {1}
openReturns.table.dueDate = Date due
openReturns.table.status = Status
openReturns.status.1 = Open
openReturns.status.2 = Overdue
openReturns.empty.title = No returns to file
openReturns.empty.heading = No returns to file
openReturns.empty.body = You are up to date on your returns.
